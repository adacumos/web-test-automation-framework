@smoke
Feature: Ripped In 90 Days Funnel

    Background: Load test data
        Given The user loads the VS test data

    Scenario: Ripped In 90 Days Funnel
        ...
        Then The user verifies the existence of "clean" order email
        ...
        Then The user validates that the "clean" purchase recorded in BrainTree
