...
Feature: SUPER SIMPLE THIRTY SECOND MORNING HABIT VIDEO AND SALES FUNNEL
    ...
    Scenario: Click video and follow through sales funnel
        ...
        Then The user verifies the "CanYou" video under, the More Ways To Reach Your Fitness Goals section
        Then The user lands on the "rippedURL" page
        ...
        Then The user lands on the "testURL" page
        Then The user starts the video
        Then The user pauses the video
        Then The user Resizes the browser to mobile view
        Then The user starts the video
        ...
        Then The user skips the video
        Then The user selects the single upgrade option
        Then The user lands on the "burnPMURL" page
        Then The user starts the video
        Then The user pauses the video
        Then The user Resizes the browser to mobile view
        Then The user starts the video
        ...
        Then The user skips the video
        Then The user selects the single upgrade option
        Then The user lands on the "creatineURL" page
        Then The user starts the video
        Then The user pauses the video
        Then The user Resizes the browser to mobile view
        Then The user starts the video
        ...
        Then The user skips the video
        Then The user selects the single upgrade option
        Then The user lands on the "specialOffer" page
        ...
        Then The user verfies Ripped in 90 Days on the Order Confirmation Page
        ...
        Then The user verfies The Big Arms Program on the Order Confirmation Page
        Then The user verfies Test Boost Max and Price on the Order Confirmation Page
