@salesTax
Feature: Salestax order verification from LE Vshred with Connecticut state address
    Background: Load test data
        Given The user loads the LE test data

    Scenario: Verify Sales Tax on orders created with Connecticut state address
