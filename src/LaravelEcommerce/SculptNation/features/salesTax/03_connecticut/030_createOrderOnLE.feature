@salesTax
Feature: Salestax order verification from LE having Connecticut state address
    Background: Load test data
        Given The user loads the LE test data

    Scenario: Verify Sales Tax on orders created having Connecticut state address
