@QA-2340 @leMove @funnelPages @bootyBuilder @clientPurchase
Feature: LE Move Landing page - /sp/the-booty-builder
    Background: Load test data
        Given The user loads the LE test data

    Scenario: Booty Builder Program - Skip All Funnel Offers
        Given The user navigates to V Shred Survey page
        When The user clicks "Purchase The Booty Builder" button
    ...
    Scenario: Booty Builder Program - Select All Funnel Offers
        Given The user navigates to V Shred Survey page
        When The user clicks "Purchase The Booty Builder" button
        Then The user verifies the Checkout form Order details
        And The user fills out the survey order form
    ...
    Scenario: Booty Builder Program - Select Some Funnel Offers
        Given The user navigates to V Shred Survey page
