@QA-2343 @leMove @funnelPages @cleanBulk @clientPurchase
Feature: LE Move Landing page - /programs/clean-bulk-program
    Background: Load test data
        Given The user loads the LE test data

    Scenario: Clean Bulk Program - Skip All Funnel Offers
    ...
    Scenario: Clean Bulk Program - Select All Funnel Offers
        Given The user navigates to V Shred Survey page
        When The user clicks "EVERYTHING FOR JUST $87.00" button
        Then The user verifies the Checkout form Order details
        And The user fills out the survey order form
    ...
    Scenario: Clean Bulk Program - Select Some Funnel Offers
        Given The user navigates to V Shred Survey page
        When The user clicks "EVERYTHING FOR JUST $87.00" button
        Then The user verifies the Checkout form Order details
        And The user fills out the survey order form
