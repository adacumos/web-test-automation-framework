...
Feature: SUPER SIMPLE THIRTY SECOND MORNING HABIT VIDEO AND SALES FUNNEL
    ...
    Scenario: Click video and follow through sales funnel
        ...
        Then The user verifies the "SuperSimple" video under, the More Ways To Reach Your Fitness Goals section
        ...
        Then The user verfies Fat Loss Extreme for Her on the Order Confirmation Page
        Then The user verfies Fat Loss Extreme for Him on the Order Confirmation Page
        ...
        Then The user verfies Enzymes and Price on the Order Confirmation Page
