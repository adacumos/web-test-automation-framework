@QA-2089 @QA-2076 @QA-2077 @QA-2078 @trainerTool @leCore @ttSmoke @vsPrograms @cdp
Feature: E2E Purchase Custom Diet Plan through LE V Shred Funnel page
    Background: Load test data
        Given The user loads the LE test data

    Scenario: LE VS Survey - Fatloss Extreme for Him with CDP Funnel Offer
