@trainerTool @vsPrograms @clientPurchase @cdp
Feature:  E2E: Purchase Custom Diet Plan as a Bumper to Digital purchase
    Background: Load test data
        Given The user loads the LE test data
    @mobileView
    Scenario: VShred Programs: Clean Bulk - CDP Bumper
        ...
        When The user selects VShred "Clean Bulk" Program
    ...
    Scenario: VShred Programs: Clean Bulk - CDP Funnel
