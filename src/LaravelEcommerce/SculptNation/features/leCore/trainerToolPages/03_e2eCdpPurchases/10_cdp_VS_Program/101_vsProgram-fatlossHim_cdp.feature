@QA-2324 @trainerTool @vsPrograms @clientPurchase @cdp
Feature:  E2E: Purchase Custom Diet Plan as a Bumper to Digital purchase
    Background: Load test data
        Given The user loads the LE test data
    Scenario: VShred Programs: Fatloss Extreme for Him - CDP Bumper
        Given The user navigates to VShred landing page
        When The user selects VShred "Fat Loss for Him" Program
    ...
    @mobileView
    Scenario: VShred Programs: Fatloss Extreme for Him - CDP Funnel
