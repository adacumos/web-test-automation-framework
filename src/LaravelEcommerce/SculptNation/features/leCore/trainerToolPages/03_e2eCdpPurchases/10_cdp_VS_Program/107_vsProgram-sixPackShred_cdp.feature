@trainerTool @vsPrograms @clientPurchase @cdp @levsSmoke
Feature:  E2E: Purchase Custom Diet Plan as a Bumper to Digital purchase
    Background: Load test data
        Given The user loads the LE test data

    @mobileView
    Scenario: VShred Programs: Six-Pack Shred - CDP Bumper
        Given The user Resizes the browser to "Samsung S24"
        Given The user navigates to VShred landing page
        And The user browse All Programs
        When The user selects VShred "Six Pack Shred" Program
    ...
    Scenario: VShred Programs: Six-Pack Shred - CDP Funnel
        Given The user navigates to VShred landing page
        And The user browse All Programs
        When The user selects VShred "Six Pack Shred" Program
        Then The user verifies the Checkout form Order details
