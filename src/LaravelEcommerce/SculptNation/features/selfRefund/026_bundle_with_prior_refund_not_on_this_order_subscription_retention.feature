@selfRefund
Feature: Self Refund with prior refund not on this order with subscription retention
    ...
    Scenario: Self Refund With Prior Refund Not On This Order
        ...
        Given The user logs into the SculptNation account
        When The user settles the payment
        Then The user creates a "bundle" refund with "prior refund not on this order" with subscription "retention"
