@ats-77 @pixelTests @snapchat @surveygaHashPixel
Feature: LE-VS Snapchat Event Pixel Testing - Consolidated
    Background: Load test data
        Given The user loads the LE test data

    Scenario: LE-VS Survey and Purchase Snapchat Tag Pixel Testing - female - 20 more of fat
    ...
    Scenario: LE-VS Survey and Purchase Snapchat Tag Pixel Testing - female - Get Toned
        Given The user navigates to V Shred Survey page with endpoint "survey-ga#"
        When The user starts new Survey GA Funnel for "Woman"
        Then The user begins tracking Sculptnation "Page View" event
    ...
    Scenario: LE-VS Survey and Purchase Snapchat Tag Pixel Testing - male - not happy with my body
        Given The user navigates to V Shred Survey page with endpoint "survey-ga#"
    ...
    Scenario: LE-VS Survey and Purchase Snapchat Tag Pixel Testing - male - skinny fat
        Given The user navigates to V Shred Survey page with endpoint "survey-ga#"
        When The user starts new Survey GA Funnel for "Man"
        Then The user begins tracking Sculptnation "Page View" event
        Then The user begins tracking Sculptnation "Quiz Completed" event
