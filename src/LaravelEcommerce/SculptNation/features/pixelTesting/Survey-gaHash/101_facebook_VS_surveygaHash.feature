@QA-2592 @pixelTests @facebook @surveygaHashPixel
Feature: V Shred Facebook Pixel Testing - Upsell
    Background: Load test data
        Given The user loads the LE test data

    Scenario: Facebook - Vshred Survey survey-ga  pixel testing - male - happy with my body but
    ...
    Scenario: Facebook - Vshred Survey survey-ga pixel testing - female - soft
        When The user begins tracking and navigates to V Shred Survey "survey-ga#" - "Facebook"
