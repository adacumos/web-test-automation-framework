@QA-1295 @MD @landingPages
Feature: Create Collagen orders via Sculptnation landing page
    Background: Load test data
        Given The user loads the LE test data

    Scenario: Create one tub order from from Wellness and Anti-Aging Support page section
        ...
        Then The user clicks "Multi_Collagen" bottle image 2 on the landing page
    ...
    Scenario: Create six tubs order from Wellness and Anti-Aging Support page section
        Given The user navigates to the SculptNation homepage
        When The user navigates to "Wellness Anti Aging Support" section of the landing page
        And The user clicks "Multi_Collagen" bottle image 2 on the landing page
        Then The user clicks Buy Now button from the product page
    ...
    Scenario: reate three bottle order from Wellness and Anti-Aging Support page section
        Given The user navigates to the SculptNation homepage
        When The user navigates to "Wellness Anti Aging Support" section of the landing page
        And The user clicks "Multi_Collagen" bottle image 2 on the landing page
        Then The user clicks Buy Now button from the product page
