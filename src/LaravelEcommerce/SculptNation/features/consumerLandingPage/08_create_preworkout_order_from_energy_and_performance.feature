@QA-818 @MD @landingPages
Feature: Create Pre-Workout orders via Sculptnation landing page
    Background: Load test data
        Given The user loads the LE test data

    Scenario: Create subscription order from Energy & Perfomance page section
        ...
        Then The user clicks "Pre Workout" bottle image 1 on the landing page
    ...
    Scenario: Create one bottle order from Energy & Perfomance page section
        Given The user navigates to the SculptNation homepage
        When The user navigates to "Energy Performance-" section of the landing page
        Then The user clicks "Pre Workout" bottle image 1 on the landing page
    ...
    Scenario: Create six bottle order from Energy & Perfomance page section
        Given The user navigates to the SculptNation homepage
        When The user navigates to "Energy Performance-" section of the landing page
        Then The user clicks "Pre Workout" bottle image 1 on the landing page
        Then The user clicks Buy Now button from the product page
    ...
    Scenario: Create three bottle order from Energy & Perfomance page section
        Given The user navigates to the SculptNation homepage
        When The user navigates to "Energy Performance-" section of the landing page
        Then The user clicks "Pre Workout" bottle image 1 on the landing page
        Then The user clicks Buy Now button from the product page
