...
Feature: Create TestBoost Max orders via Sculptnation landing page
    ...
    Scenario: Create subscription order from Energy Performance page section
        ...
        Then The user clicks "Test Boost Max" bottle image 3 on the landing page
    ...
    Scenario: Create six bottle order from Energy Performance page section
        Given The user navigates to the SculptNation homepage
        When The user navigates to "Energy Performance-" section of the landing page
        And The user clicks "Test Boost Max" bottle image 3 on the landing page
        Then The user clicks Buy Now button from the product page
