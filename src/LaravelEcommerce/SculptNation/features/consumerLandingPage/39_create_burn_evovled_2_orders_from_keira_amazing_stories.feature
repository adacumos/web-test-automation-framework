@QA-1829 @MD @landingPages
Feature: Create Burn Evolved 2.0 orders via Sculptnation landing page
    Background: Load test data
        Given The user loads the LE test data

    Scenario: Create subscription order from Keira Amazing Success Stories page section
        ...
        And The user clicks "Burn Favorite 2.0" bottle image 1 on the landing page
    ...
    Scenario: Create one bottle order from Keira Amazing Success Stories page section
        Given The user navigates to the SculptNation homepage
        When The user browses to "Amazing Success Stories" section of the landing page
        Then The user verifies that "Kiera" image exists
        And The user clicks "Burn Favorite 2.0" bottle image 1 on the landing page
    ...
    Scenario: Create six bottle order from Keira Amazing Success Stories page section
        Given The user navigates to the SculptNation homepage
        When The user browses to "Amazing Success Stories" section of the landing page
        Then The user verifies that "Kiera" image exists
        And The user clicks "Burn Favorite 2.0" bottle image 1 on the landing page
    ...
    Scenario: Create three bottle order from Keira Amazing Success Stories page section
        Given The user navigates to the SculptNation homepage
        When The user browses to "Amazing Success Stories" section of the landing page
        Then The user verifies that "Kiera" image exists
        And The user clicks "Burn Favorite 2.0" bottle image 1 on the landing page
