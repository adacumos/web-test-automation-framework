@QA-707 @QA-708 @QA-709 @QA-710 @QA-711 @MD @landingPages
Feature: Create Neuroctane orders via Sculptnation landing page
    Background: Load test data
        Given The user loads the LE test data

    Scenario: Create subscription order from Wellness and Anti-Aging Support page section
        Given The user navigates to the SculptNation homepage
        When The user navigates to "Wellness Anti Aging Support" section of the landing page
        Then The user clicks "Neuroctane" bottle image 1 on the landing page
    ...
    Scenario: Create one bottle order from Wellness and Anti-Aging Support page section
        Given The user navigates to the SculptNation homepage
        When The user navigates to "Wellness Anti Aging Support" section of the landing page
        And The user clicks "Neuroctane" bottle image 1 on the landing page
    ...
    Scenario: Create six bottle order from Wellness and Anti-Aging Support page section
        Given The user navigates to the SculptNation homepage
        When The user navigates to "Wellness Anti Aging Support" section of the landing page
        And The user clicks "Neuroctane" bottle image 1 on the landing page
        Then The user clicks Buy Now button from the product page
    ...
    Scenario: Create three bottle order from Wellness and Anti-Aging Support page section
        Given The user navigates to the SculptNation homepage
        When The user navigates to "Wellness Anti Aging Support" section of the landing page
        And The user clicks "Neuroctane" bottle image 1 on the landing page
        Then The user clicks Buy Now button from the product page
