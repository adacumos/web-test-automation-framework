@QA-1272 @MD @landingPages @landingPages
Feature: Create Turmeric Black orders via Sculptnation landing page
    Background: Load test data
        Given The user loads the LE test data

    Scenario: Create subscription order from Weight Loss Fat Burning page section
        ...
        Then The user clicks "Turmeric Black" bottle image 2 on the landing page
    ...
    Scenario: Create one bottle order from Weight Loss Fat Burning page section
        Given The user navigates to the SculptNation homepage
        When The user navigates to "Weight Loss Fat Burning" section of the landing page
        Then The user clicks "Turmeric Black" bottle image 2 on the landing page
    ...
    Scenario: Create six bottle order from Weight Loss Fat Burning page section
        Given The user navigates to the SculptNation homepage
        When The user navigates to "Weight Loss Fat Burning" section of the landing page
        Then The user clicks "Turmeric Black" bottle image 2 on the landing page
        Then The user clicks Buy Now button from the product page
    ...
    Scenario: Create three bottle order from Weight Loss Fat Burning page section
        Given The user navigates to the SculptNation homepage
        When The user navigates to "Weight Loss Fat Burning" section of the landing page
        Then The user clicks "Turmeric Black" bottle image 2 on the landing page
        Then The user clicks Buy Now button from the product page
