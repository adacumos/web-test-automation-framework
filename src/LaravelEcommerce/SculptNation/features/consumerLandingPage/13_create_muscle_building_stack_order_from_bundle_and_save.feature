@QA-814 @QA-806 @QA-804 @MD @landingPages
Feature: Create Muscle Building Stack orders via Sculptnation landing page
    ...
    Scenario: Create subscription order from Bundle & Save page section
        ...
        And The user clicks the Subscribe Now button under the One Bottle option on the "fourth" upsell page
    ...
    Scenario: Create three bottle order from Bundle & Save page section
        Given The user navigates to the SculptNation homepage
        When The user browses to "Bundle & Save" section of the landing page
        And The user clicks "Muscle Building" bottle image 1 on the landing page
