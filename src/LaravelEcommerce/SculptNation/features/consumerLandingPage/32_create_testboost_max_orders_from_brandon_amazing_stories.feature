@QA-1307 @MD @landingPages
Feature: Create Test Boost Max orders via Sculptnation landing page
    Background: Load test data
        Given The user loads the LE test data

    Scenario: Create subscription order from Brandon Amazing Success Stories page section
        ...
        Then The user clicks "Test Boost Max Favorite" bottle image 1 on the landing page
    ...
    Scenario: Create one bottle order from Brandon Amazing Success Stories page section
        Given The user navigates to the SculptNation homepage
        When The user browses to "Amazing Success Stories" section of the landing page
        Then The user clicks the arrow right slider button
        And The user verifies that "Brandon" image exists
    ...
    Scenario: Create six bottle order from Brandon Amazing Success Stories page section
        Given The user navigates to the SculptNation homepage
        When The user browses to "Amazing Success Stories" section of the landing page
        Then The user clicks the arrow right slider button
        And The user verifies that "Brandon" image exists
    ...
    Scenario: Create three bottle order from Brandon Amazing Success Stories page section
        Given The user navigates to the SculptNation homepage
        When The user browses to "Amazing Success Stories" section of the landing page
        Then The user clicks the arrow right slider button
        And The user verifies that "Brandon" image exists
