@QA-1398 @MD @landingPages
Feature: Create Pre-Workout orders via Sculptnation landing page
    Background: Load test data
        Given The user loads the LE test data

    Scenario: Create subscription order from Workout & Recovery page section
        ...
        Then The user clicks "Pre Workout" bottle image 2 on the landing page
