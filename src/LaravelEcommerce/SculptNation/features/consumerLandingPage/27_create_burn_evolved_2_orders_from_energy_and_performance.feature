@QA-1287 @MD @landingPages
Feature: Create Burn Evolved 2.0 orders via Sculptnation landing page
    Background: Load test data
        Given The user loads the LE test data

    Scenario: Create subscription order from Energy Performance page section
        Given The user navigates to the SculptNation homepage
        When The user navigates to "Energy Performance-" section of the landing page
        Then The user clicks "Burn Evolved 2.0" bottle image 3 on the landing page
    ...
    Scenario: Create one bottle order from Energy Performance page section
        Given The user navigates to the SculptNation homepage
        When The user navigates to "Energy Performance-" section of the landing page
        Then The user clicks "Burn Evolved 2.0" bottle image 3 on the landing page
    ...
    Scenario: Create six bottle order from Most Energy Performance page section
        Given The user navigates to the SculptNation homepage
        When The user navigates to "Energy Performance-" section of the landing page
        And The user clicks "Burn Evolved 2.0" bottle image 3 on the landing page
        Then The user clicks Buy Now button from the product page
    ...
    Scenario: Create three bottle order from Energy Performance page section
        Given The user navigates to the SculptNation homepage
        When The user navigates to "Energy Performance-" section of the landing page
        And The user clicks "Burn Evolved 2.0" bottle image 3 on the landing page
        Then The user clicks Buy Now button from the product page
