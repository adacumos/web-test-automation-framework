@QA-848 @MD @landingPages
Feature: Create Post-Workout orders via Sculptnation landing page
    Background: Load test data
        Given The user loads the LE test data

    Scenario: Create subscription order from Workout & Reovery page section
        Given The user navigates to the SculptNation homepage
        When The user navigates to "Workout Recovery" section of the landing page
        Then The user clicks "Post Workout" bottle image 1 on the landing page
        ...
        And The user dismisses the "Protein" offer
    ...
    Scenario: Create one bottle order from Workout & Recovery page section
        Given The user navigates to the SculptNation homepage
        When The user navigates to "Workout Recovery" section of the landing page
        Then The user clicks "Post Workout" bottle image 1 on the landing page
    ...
    Scenario: Create six bottle order from Workout & Recovery page section
        Given The user navigates to the SculptNation homepage
        When The user navigates to "Workout Recovery" section of the landing page
        Then The user clicks "Post Workout" bottle image 1 on the landing page
        Then The user clicks Buy Now button from the product page
    ...
    Scenario: Create three bottle order from Workout & Recovery page section
        Given The user navigates to the SculptNation homepage
        When The user navigates to "Workout Recovery" section of the landing page
        Then The user clicks "Post Workout" bottle image 1 on the landing page
        Then The user clicks Buy Now button from the product page
