@QA-1308 @MD @landingPages
Feature: Create Burn Evolved 2.0 orders via Sculptnation landing page
    Background: Load test data
        Given The user loads the LE test data

    Scenario: Create subscription order from Renae Amazing Success Stories page section
        ...
        And The user clicks "Burn Favorite 2.0" bottle image 3 on the landing page
    ...
    Scenario: Create one bottle order from Renae Amazing Success Stories page section
        Given The user navigates to the SculptNation homepage
        When The user browses to "Amazing Success Stories" section of the landing page
        Then The user clicks the arrow right slider button
        And The user clicks the arrow right slider button
    ...
    Scenario: Create six bottle order from Renae Amazing Success Stories page section
        Given The user navigates to the SculptNation homepage
        When The user browses to "Amazing Success Stories" section of the landing page
        Then The user clicks the arrow right slider button
        And The user clicks the arrow right slider button
    ...
    Scenario: Create three bottle order from Renae Amazing Success Stories page section
        Given The user navigates to the SculptNation homepage
        When The user browses to "Amazing Success Stories" section of the landing page
        Then The user clicks the arrow right slider button
        And The user clicks the arrow right slider button
