@QA-602 @MD @adminTool @betaRefunds
Feature: Refund Shipping Item
    Background: Load test data
        Given The user loads the LE test data

    Scenario: Refund Shipping Item
        ...
        And The user clicks the Refund Order Item button on row "3"
        ...
        Then The user validates the "Refunded Shipping" data on the Order Details page
        When The user clicks on the "Order Offers" tab on the Order Details page
        Then The user validates the "Refunded Shipping" Order data on row "1" of the Order Offers page
        And The user validates the "Refunded Shipping" Order data on row "2" of the Order Offers page
        And The user validates the "Refunded Shipping" Order data on row "3" of the Order Offers page
        ...
        Then The user validates the "Refunded Shipping" Order data on the Payments page
