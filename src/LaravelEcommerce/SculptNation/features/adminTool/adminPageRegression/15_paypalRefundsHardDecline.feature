@QA-1791
Feature: Paypal Refunds Hard Decline
    Background: Load test data
        Given The user loads the LE test data

    Scenario: Paypal Refunds Hard Decline With Email Linked To Paypal
    ...
    Scenario: Paypal Refunds Hard Decline With Email Not Linked To Paypal
        Given The user logs into the Admin Tool using an account with "admin" credentials
