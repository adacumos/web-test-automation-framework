...
Feature: Refund Order with Shipping
    ...
    Scenario: Refund Order with Shipping
        ...
        Then The user validates the "Refunded Order with Shipping" data on the Order Details page
        When The user clicks on the "Order Offers" tab on the Order Details page
        Then The user validates the "Refunded Order with Shipping" Order data on row "1" of the Order Offers page
        And The user validates the "Refunded Order with Shipping" Order data on row "2" of the Order Offers page
        And The user validates the "Refunded Order with Shipping" Order data on row "3" of the Order Offers page
        ...
        Then The user validates the "Refunded Order with Shipping" Order data on the Payments page
