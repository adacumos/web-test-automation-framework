@MD @adminTool @betaRefunds
Feature: Refund Order without Shipping
    Background: Load test data
        Given The user loads the LE test data

    Scenario: Refund Order without Shipping
        ...
        And The user initiates a "Entire Order without Shipping" refund using the Refund Order widget
        When The user clicks on the "Details" tab on the Order Details page
        Then The user validates the "Refunded Order without Shipping" data on the Order Details page
        When The user clicks on the "Order Offers" tab on the Order Details page
        Then The user validates the "Refunded Order without Shipping" Order data on row "1" of the Order Offers page
        And The user validates the "Refunded Order without Shipping" Order data on row "2" of the Order Offers page
        And The user validates the "Refunded Order without Shipping" Order data on row "3" of the Order Offers page
        ...
        Then The user validates the "Refunded Order without Shipping" Order data on the Payments page
