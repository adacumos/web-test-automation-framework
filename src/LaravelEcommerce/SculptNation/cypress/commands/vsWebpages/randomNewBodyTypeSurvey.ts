...
declare global {
    namespace Cypress {
        interface Chainable {
            randomNewBodyTypeSurvey: (gender: string) => void;
        }
    }
}
/**
 * command used to generate ramdom selection to NEW Body Type Survey
 * @param gender User Gender selection
 * example:  randomNewBodyTypeSurvey('Male')
 */

export const randomNewBodyTypeSurvey = (gender: string): void => {
